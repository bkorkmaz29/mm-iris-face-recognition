...
class MMR:
    ...
    def delete_subject(self, subject_dir):
        subject = self.format_name(subject_dir)
        dir = self.data_dir + subject_dir
    ...
    def get_iris_scores(self, template_search, mask_search, data_dir):
        ...
        for file in files:
            ...
            mask = iris_data['mask']
            dist_list.append(IrisRec.cal_distance(
